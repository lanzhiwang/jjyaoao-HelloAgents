        ...
        result = self.rl_tool.run(
            {
                ...
                "use_tensorboard": self.config.get("monitoring", {}).get(
                    "use_tensorboard", True
                ),
                "wandb_project": self.config.get("monitoring", {}).get(
                    "wandb_project", None
                ),
            }
        )
...
if __name__ == "__main__":
    ...
    config = {
        ...
        "data": {"max_samples": 100},  # 使用100个样本快速测试
        "sft": {
        ...
        "eval": {"max_samples": 20, "sft_accuracy_threshold": 0.40},
        "monitoring": {
